  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved produto as @produto" do
        ...
        post :create, {:produto => { "name" => "invalid value" }}, valid_session
        assigns(:produto).should be_a_new(Produto)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested produto" do
        ...
        Produto.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => produto.to_param, :produto => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the produto as @produto" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Produto.any_instance.stub(:save).and_return(false)
        put :update, {:id => produto.to_param, :produto => { "name" => "invalid value" }}, valid_session
        assigns(:produto).should eq(produto)
      end
